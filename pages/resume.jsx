  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="My focus is on building beautiful Frontend Web and Mobile applications with great usability, scalability and performance to improve and facilitate people`s lives."
        />
      ...
      <div className="max-w-[940px] mx-auto p-2 pt-[120px]">
        ...
        <div className="bg-[#d0d4d6] my-4 p-4 w-full flex justify-between items-center">
          <h2 className="text-center">Guilherme Martins</h2>
          <div className="flex">
            <a
        ...
        <div className="py-6">
          <p className="italic">
            <span className="italic font-bold">INFINITE TECH</span>
