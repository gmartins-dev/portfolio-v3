...
const Contact = () => {
  return (
    <div id='contact' className='w-full pt-16 lg:h-screen'>
          ...
          <div className='col-span-3 lg:col-span-2 w-full h-full shadow-xl shadow-[#005687] rounded-xl p-4'>
            <div className='h-full lg:p-4 '>
              ...
              <div>
                ...
                <p className='py-4'>
                  I am available for freelance or full-time positions. Local in
                  Bristol(UK) or remotely anywhere. Contact me and let&apos;s
                  talk.
                </p>
              </div>
              <div>
