...
const ProjectItem = ({ title, backgroundImg, tech, projectUrl }) => {
  return (
    <div className='relative flex items-center justify-center h-full w-full shadow-xl shadow-[#005687] rounded-xl group hover:bg-gradient-to-r from-[#2A7AE2] to-[#709dff]'>
      <Image
        className='rounded-xl group-hover:opacity-10 h-96'
        src={backgroundImg}
        alt='/'
        height=''
        width=''
